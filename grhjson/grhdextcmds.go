...
// a chain server with grhd extensions.
...
// standard GetRichCoin command.  It is an extension for grhd.
type DebugLevelCmd struct {
	LevelSpec string
}

// NewDebugLevelCmd returns a new DebugLevelCmd which can be used to issue a
// debuglevel JSON-RPC command.  This command is not a standard GetRichCoin command.
// It is an extension for grhd.
