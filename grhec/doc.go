...
/*
Package grhec implements support for the elliptic curves needed for getrichcoin.

GetRichCoin uses elliptic curve cryptography using koblitz curves
...
standard formats.  It was designed for use with grhd, but should be
