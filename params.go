...
// currently active getrichcoin network.
...
// reference implementation because grhd does not handle wallet requests.  The
// separate wallet process listens on the well-known port and forwards requests
// it does not handle on to grhd.  This approach allows the wallet process
