...
/*
Package txscript implements the getrichcoin transaction script language.

A complete description of the script language used by getrichcoin can be found at
https://en.getrichcoin.it/wiki/Script.  The following only serves as a quick
...
getrichcoin transaction scripts.

Script Overview

GetRichCoin transaction scripts are written in a stack-base, FORTH-like language.

The getrichcoin script language consists of a number of opcodes which fall into
...
The vast majority of GetRichCoin scripts at the time of this writing are of several
...
what conditions must be met in order to spend getrichcoins.
