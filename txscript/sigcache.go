...
// https://bitslog.wordpress.com/2013/01/23/fixed-getrichcoin-vulnerability-explanation-why-the-signature-cache-is-a-dos-protection/.
...
func (s *SigCache) Exists(sigHash chainhash.Hash, sig *grhec.Signature, pubKey *grhec.PublicKey) bool {
	s.RLock()
...
func (s *SigCache) Add(sigHash chainhash.Hash, sig *grhec.Signature, pubKey *grhec.PublicKey) {
	s.Lock()
	defer s.Unlock()
