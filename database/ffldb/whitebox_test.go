...
// a slice of them.
func loadBlocks(t *testing.T, dataFile string, network wire.GetRichCoinNet) ([]*grhutil.Block, error) {
	...
	blocks := make([]*grhutil.Block, 0, 256)
	genesis := grhutil.NewBlock(chaincfg.MainNetParams.GenesisBlock)
