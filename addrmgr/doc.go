...
/*
Package addrmgr implements concurrency safe GetRichCoin address manager.

Address Manager Overview

In order maintain the peer-to-peer GetRichCoin network, there needs to be a source
of addresses to connect to as nodes come and go.  The GetRichCoin protocol provides
