...
func (c *Client) AddNodeAsync(host string, command AddNodeCommand) FutureAddNodeResult {
	cmd := grhjson.NewAddNodeCmd(host, grhjson.AddNodeSubCmd(command))
...
func (r FutureGetAddedNodeInfoResult) Receive() ([]grhjson.GetAddedNodeInfoResult, error) {
	...
	var nodeInfo []grhjson.GetAddedNodeInfoResult
...
func (c *Client) GetAddedNodeInfoAsync(peer string) FutureGetAddedNodeInfoResult {
	cmd := grhjson.NewGetAddedNodeInfoCmd(true, &peer)
	return c.sendCmd(cmd)
}
...
// peers.
func (c *Client) GetAddedNodeInfo(peer string) ([]grhjson.GetAddedNodeInfoResult, error) {
...
func (c *Client) GetAddedNodeInfoNoDNSAsync(peer string) FutureGetAddedNodeInfoNoDNSResult {
	cmd := grhjson.NewGetAddedNodeInfoCmd(false, &peer)
	return c.sendCmd(cmd)
}
...
func (c *Client) GetConnectionCountAsync() FutureGetConnectionCountResult {
	cmd := grhjson.NewGetConnectionCountCmd()
	return c.sendCmd(cmd)
}
...
func (r FutureGetPeerInfoResult) Receive() ([]grhjson.GetPeerInfoResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var peerInfo []grhjson.GetPeerInfoResult
...
func (c *Client) GetPeerInfoAsync() FutureGetPeerInfoResult {
	cmd := grhjson.NewGetPeerInfoCmd()
	return c.sendCmd(cmd)
}

// GetPeerInfo returns data about each connected network peer.
func (c *Client) GetPeerInfo() ([]grhjson.GetPeerInfoResult, error) {
...
// traffic statistics.
func (r FutureGetNetTotalsResult) Receive() (*grhjson.GetNetTotalsResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var totals grhjson.GetNetTotalsResult
...
func (c *Client) GetNetTotalsAsync() FutureGetNetTotalsResult {
	cmd := grhjson.NewGetNetTotalsCmd()
	return c.sendCmd(cmd)
}

// GetNetTotals returns network traffic statistics.
func (c *Client) GetNetTotals() (*grhjson.GetNetTotalsResult, error) {
