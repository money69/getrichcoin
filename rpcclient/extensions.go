...
//
// NOTE: This is a grhd extension.
func (c *Client) DebugLevelAsync(levelSpec string) FutureDebugLevelResult {
	cmd := grhjson.NewDebugLevelCmd(levelSpec)
...
func (r FutureListAddressTransactionsResult) Receive() ([]grhjson.ListTransactionsResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
...
//
// NOTE: This is a grhd extension.
func (c *Client) ListAddressTransactionsAsync(addresses []grhutil.Address, account string) FutureListAddressTransactionsResult {
	// Convert addresses to strings.
	addrs := make([]string, 0, len(addresses))
	for _, addr := range addresses {
		addrs = append(addrs, addr.EncodeAddress())
	}
	cmd := grhjson.NewListAddressTransactionsCmd(addrs, &account)
	return c.sendCmd(cmd)
}
...
//
// NOTE: This is a grhwallet extension.
func (c *Client) ListAddressTransactions(addresses []grhutil.Address, account string) ([]grhjson.ListTransactionsResult, error) {
...
func (r FutureGetBestBlockResult) Receive() (*chainhash.Hash, int32, error) {
	...
	var bestBlock grhjson.GetBestBlockResult
...
func (c *Client) GetBestBlockAsync() FutureGetBestBlockResult {
	cmd := grhjson.NewGetBestBlockCmd()
	return c.sendCmd(cmd)
}
...
func (r FutureGetCurrentNetResult) Receive() (wire.GetRichCoinNet, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
	...
	return wire.GetRichCoinNet(net), nil
}
...
func (c *Client) GetCurrentNetAsync() FutureGetCurrentNetResult {
	cmd := grhjson.NewGetCurrentNetCmd()
	return c.sendCmd(cmd)
}
...
//
// NOTE: This is a grhd extension.
func (c *Client) GetCurrentNet() (wire.GetRichCoinNet, error) {
...
func (c *Client) GetHeadersAsync(blockLocators []chainhash.Hash, hashStop *chainhash.Hash) FutureGetHeadersResult {
	...
	cmd := grhjson.NewGetHeadersCmd(locators, hash)
	return c.sendCmd(cmd)
}
...
func (c *Client) ExportWatchingWalletAsync(account string) FutureExportWatchingWalletResult {
	cmd := grhjson.NewExportWatchingWalletCmd(&account, grhjson.Bool(true))
	return c.sendCmd(cmd)
}
...
// used by grhwallet to enable a wallet which does not have the private keys
...
// Receive waits for the response promised by the future and returns the
// session result.
func (r FutureSessionResult) Receive() (*grhjson.SessionResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var session grhjson.SessionResult
...
//
// NOTE: This is a grhsuite extension.
...
//
// NOTE: This is a grhsuite extension.
func (c *Client) Session() (*grhjson.SessionResult, error) {
...
// NOTE: This is a grhsuite extension ported from
// github.com/decred/dcrrpcclient.
func (r FutureVersionResult) Receive() (map[string]grhjson.VersionResult,
	error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	...
	var vr map[string]grhjson.VersionResult
...
// NOTE: This is a grhsuite extension ported from
// github.com/decred/dcrrpcclient.
func (c *Client) Version() (map[string]grhjson.VersionResult, error) {
