...
func (c *Client) GetBestBlockHashAsync() FutureGetBestBlockHashResult {
	cmd := grhjson.NewGetBestBlockHashCmd()
...
func (c *Client) GetBlockAsync(blockHash *chainhash.Hash) FutureGetBlockResult {
	...
	cmd := grhjson.NewGetBlockCmd(hash, grhjson.Bool(false), nil)
	return c.sendCmd(cmd)
}
...
func (r FutureGetBlockVerboseResult) Receive() (*grhjson.GetBlockVerboseResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var blockResult grhjson.GetBlockVerboseResult
...
func (c *Client) GetBlockVerboseAsync(blockHash *chainhash.Hash) FutureGetBlockVerboseResult {
	...
	cmd := grhjson.NewGetBlockCmd(hash, grhjson.Bool(true), nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) GetBlockVerbose(blockHash *chainhash.Hash) (*grhjson.GetBlockVerboseResult, error) {
...
func (c *Client) GetBlockVerboseTxAsync(blockHash *chainhash.Hash) FutureGetBlockVerboseResult {
	...
	cmd := grhjson.NewGetBlockCmd(hash, grhjson.Bool(true), grhjson.Bool(true))
	return c.sendCmd(cmd)
}
...
// See GetBlock to retrieve a raw block instead.
func (c *Client) GetBlockVerboseTx(blockHash *chainhash.Hash) (*grhjson.GetBlockVerboseResult, error) {
...
func (c *Client) GetBlockCountAsync() FutureGetBlockCountResult {
	cmd := grhjson.NewGetBlockCountCmd()
	return c.sendCmd(cmd)
}
...
func (c *Client) GetDifficultyAsync() FutureGetDifficultyResult {
	cmd := grhjson.NewGetDifficultyCmd()
	return c.sendCmd(cmd)
}
...
func (r FutureGetBlockChainInfoResult) Receive() (*grhjson.GetBlockChainInfoResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}

	var chainInfo grhjson.GetBlockChainInfoResult
...
func (c *Client) GetBlockChainInfoAsync() FutureGetBlockChainInfoResult {
	cmd := grhjson.NewGetBlockChainInfoCmd()
	return c.sendCmd(cmd)
}
...
// of the main chain.
func (c *Client) GetBlockChainInfo() (*grhjson.GetBlockChainInfoResult, error) {
...
func (c *Client) GetBlockHashAsync(blockHeight int64) FutureGetBlockHashResult {
	cmd := grhjson.NewGetBlockHashCmd(blockHeight)
	return c.sendCmd(cmd)
}
...
func (c *Client) GetBlockHeaderAsync(blockHash *chainhash.Hash) FutureGetBlockHeaderResult {
	...
	cmd := grhjson.NewGetBlockHeaderCmd(hash, grhjson.Bool(false))
	return c.sendCmd(cmd)
}
...
func (r FutureGetBlockHeaderVerboseResult) Receive() (*grhjson.GetBlockHeaderVerboseResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	// Unmarshal result as a string.
	var bh grhjson.GetBlockHeaderVerboseResult
...
func (c *Client) GetBlockHeaderVerboseAsync(blockHash *chainhash.Hash) FutureGetBlockHeaderVerboseResult {
	...
	cmd := grhjson.NewGetBlockHeaderCmd(hash, grhjson.Bool(true))
	return c.sendCmd(cmd)
}
...
func (c *Client) GetBlockHeaderVerbose(blockHash *chainhash.Hash) (*grhjson.GetBlockHeaderVerboseResult, error) {
...
// its hash.
func (r FutureGetMempoolEntryResult) Receive() (*grhjson.GetMempoolEntryResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var mempoolEntryResult grhjson.GetMempoolEntryResult
...
func (c *Client) GetMempoolEntryAsync(txHash string) FutureGetMempoolEntryResult {
	cmd := grhjson.NewGetMempoolEntryCmd(txHash)
	return c.sendCmd(cmd)
}

// GetMempoolEntry returns a data structure with information about the
// transaction in the memory pool given its hash.
func (c *Client) GetMempoolEntry(txHash string) (*grhjson.GetMempoolEntryResult, error) {
...
func (c *Client) GetRawMempoolAsync() FutureGetRawMempoolResult {
	cmd := grhjson.NewGetRawMempoolCmd(grhjson.Bool(false))
	return c.sendCmd(cmd)
}
...
func (r FutureGetRawMempoolVerboseResult) Receive() (map[string]grhjson.GetRawMempoolVerboseResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	// results.
	var mempoolItems map[string]grhjson.GetRawMempoolVerboseResult
...
func (c *Client) GetRawMempoolVerboseAsync() FutureGetRawMempoolVerboseResult {
	cmd := grhjson.NewGetRawMempoolCmd(grhjson.Bool(true))
	return c.sendCmd(cmd)
}
...
func (c *Client) GetRawMempoolVerbose() (map[string]grhjson.GetRawMempoolVerboseResult, error) {
...
func (c *Client) VerifyChainAsync() FutureVerifyChainResult {
	cmd := grhjson.NewVerifyChainCmd(nil, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) VerifyChainLevelAsync(checkLevel int32) FutureVerifyChainResult {
	cmd := grhjson.NewVerifyChainCmd(&checkLevel, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) VerifyChainBlocksAsync(checkLevel, numBlocks int32) FutureVerifyChainResult {
	cmd := grhjson.NewVerifyChainCmd(&checkLevel, &numBlocks)
	return c.sendCmd(cmd)
}
...
func (r FutureGetTxOutResult) Receive() (*grhjson.GetTxOutResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var txOutInfo *grhjson.GetTxOutResult
...
func (c *Client) GetTxOutAsync(txHash *chainhash.Hash, index uint32, mempool bool) FutureGetTxOutResult {
	...
	cmd := grhjson.NewGetTxOutCmd(hash, index, &mempool)
	return c.sendCmd(cmd)
}

// GetTxOut returns the transaction output info if it's unspent and
// nil, otherwise.
func (c *Client) GetTxOut(txHash *chainhash.Hash, index uint32, mempool bool) (*grhjson.GetTxOutResult, error) {
...
// NOTE: This is a grhsuite extension ported from
// github.com/decred/dcrrpcclient.
func (r FutureRescanBlocksResult) Receive() ([]grhjson.RescannedBlock, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}

	var rescanBlocksResult []grhjson.RescannedBlock
...
func (c *Client) RescanBlocksAsync(blockHashes []chainhash.Hash) FutureRescanBlocksResult {
	...
	cmd := grhjson.NewRescanBlocksCmd(strBlockHashes)
	return c.sendCmd(cmd)
}
...
// NOTE: This is a grhsuite extension ported from
// github.com/decred/dcrrpcclient.
func (c *Client) RescanBlocks(blockHashes []chainhash.Hash) ([]grhjson.RescannedBlock, error) {
...
func (c *Client) InvalidateBlockAsync(blockHash *chainhash.Hash) FutureInvalidateBlockResult {
	...
	cmd := grhjson.NewInvalidateBlockCmd(hash)
	return c.sendCmd(cmd)
}
