...
func createCoinbaseTx(coinbaseScript []byte, nextBlockHeight int32,
	addr grhutil.Address, net *chaincfg.Params) (*grhutil.Tx, error) {
...
func CreateBlock(prevBlock *grhutil.Block, inclusionTxs []*grhutil.Tx,
	blockVersion int32, blockTime time.Time,
	miningAddr grhutil.Address, net *chaincfg.Params) (*grhutil.Block, error) {
	...
	blockTxns := []*grhutil.Tx{coinbaseTx}
	if inclusionTxs != nil {
	...
	utilBlock := grhutil.NewBlock(&block)
