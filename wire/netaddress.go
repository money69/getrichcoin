...
// maxNetAddressPayload returns the max payload size for a getrichcoin NetAddress
...
type NetAddress struct {
	...
	// not present in the getrichcoin version message (MsgVersion) nor was it
...
func readNetAddress(r io.Reader, pver uint32, na *NetAddress, ts bool) error {
	...
	// NOTE: The getrichcoin protocol uses a uint32 for the timestamp so it will
	...
	// Sigh.  GetRichCoin protocol mixes little and big endian.
