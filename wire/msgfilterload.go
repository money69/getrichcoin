...
// MsgFilterLoad implements the Message interface and represents a getrichcoin
...
// NewMsgFilterLoad returns a new getrichcoin filterload message that conforms to
