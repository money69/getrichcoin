...
// MsgGetBlocks implements the Message interface and represents a getrichcoin
...
// NewMsgGetBlocks returns a new getrichcoin getblocks message that conforms to the
