...
// MsgPong implements the Message interface and represents a getrichcoin pong
// message which is used primarily to confirm that a connection is still valid
// in response to a getrichcoin ping message (MsgPing).
//
...
// NewMsgPong returns a new getrichcoin pong message that conforms to the Message
