...
const DefaultUserAgent = "/grhwire:0.5.0/"

// MsgVersion implements the Message interface and represents a getrichcoin version
...
// NewMsgVersion returns a new getrichcoin version message that conforms to the
