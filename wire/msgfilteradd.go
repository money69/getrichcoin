...
// MsgFilterAdd implements the Message interface and represents a getrichcoin
...
// NewMsgFilterAdd returns a new getrichcoin filteradd message that conforms to the
