...
// MsgPing implements the Message interface and represents a getrichcoin ping
// message.
//
...
// NewMsgPing returns a new getrichcoin ping message that conforms to the Message
