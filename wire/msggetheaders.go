...
// MsgGetHeaders implements the Message interface and represents a getrichcoin
...
// NewMsgGetHeaders returns a new getrichcoin getheaders message that conforms to
