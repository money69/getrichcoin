...
// MsgGetData implements the Message interface and represents a getrichcoin
...
// NewMsgGetData returns a new getrichcoin getdata message that conforms to the
...
// NewMsgGetDataSizeHint returns a new getrichcoin getdata message that conforms to
