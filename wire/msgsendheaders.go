...
// MsgSendHeaders implements the Message interface and represents a getrichcoin
...
// NewMsgSendHeaders returns a new getrichcoin sendheaders message that conforms to
