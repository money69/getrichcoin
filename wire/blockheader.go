...
// BlockHeader defines information about a block and is used in the getrichcoin
...
// readBlockHeader reads a getrichcoin block header from r.  See Deserialize for
...
// writeBlockHeader writes a getrichcoin block header to w.  See Serialize for
