// Copyright (c) 2014-2015 The grhsuite developers
...
// MsgFilterClear implements the Message interface and represents a getrichcoin
...
// NewMsgFilterClear returns a new getrichcoin filterclear message that conforms to the Message
