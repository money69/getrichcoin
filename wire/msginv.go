...
// MsgInv implements the Message interface and represents a getrichcoin inv message.
...
// NewMsgInv returns a new getrichcoin inv message that conforms to the Message
...
// NewMsgInvSizeHint returns a new getrichcoin inv message that conforms to the
