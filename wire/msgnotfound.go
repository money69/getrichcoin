...
// MsgNotFound defines a getrichcoin notfound message which is sent in response to
...
// NewMsgNotFound returns a new getrichcoin notfound message that conforms to the
