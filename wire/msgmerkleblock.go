...
// MsgMerkleBlock implements the Message interface and represents a getrichcoin
...
// NewMsgMerkleBlock returns a new getrichcoin merkleblock message that conforms to
