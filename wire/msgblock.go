...
// MsgBlock implements the Message interface and represents a getrichcoin
...
// BtcDecode decodes from the getrichcoin wire protocol as it was sent across the
...
// the getrichcoin wire protocol in order to be sent across the network.  The wire
...
// NewMsgBlock returns a new getrichcoin block message that conforms to the
