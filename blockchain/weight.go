...
func GetBlockWeight(blk *grhutil.Block) int64 {
...
func GetTransactionWeight(tx *grhutil.Tx) int64 {
	msgTx := tx.MsgTx()
...
func GetSigOpCost(tx *grhutil.Tx, isCoinBaseTx bool, utxoView *UtxoViewpoint,
