...
// BlockChain provides functions for working with the getrichcoin block chain.
...
// exceeded.
func (b *BlockChain) addOrphanBlock(block *grhutil.Block) {
...
//
// This function is safe for concurrent access.
func (b *BlockChain) CalcSequenceLock(tx *grhutil.Tx, utxoView *UtxoViewpoint, mempool bool) (*SequenceLock, error) {
	b.chainLock.Lock()
...
func (b *BlockChain) calcSequenceLock(node *blockNode, tx *grhutil.Tx, utxoView *UtxoViewpoint, mempool bool) (*SequenceLock, error) {
...
// See: https://github.com/getrichcoin/bips/blob/master/bip-0068.mediawiki
//  * (Compatibility)
...
//
// This function MUST be called with the chain state lock held (for writes).
func (b *BlockChain) connectBlock(node *blockNode, block *grhutil.Block, view *UtxoViewpoint, stxos []spentTxOut) error {
...
//
// This function MUST be called with the chain state lock held (for writes).
func (b *BlockChain) disconnectBlock(node *blockNode, block *grhutil.Block, view *UtxoViewpoint) error {
...
func countSpentOutputs(block *grhutil.Block) int {
...
func (b *BlockChain) reorganizeChain(detachNodes, attachNodes *list.List) error {
	...
	detachBlocks := make([]*grhutil.Block, 0, detachNodes.Len())
	detachSpentTxOuts := make([][]spentTxOut, 0, detachNodes.Len())
	attachBlocks := make([]*grhutil.Block, 0, attachNodes.Len())
...
//
// This function MUST be called with the chain state lock held (for writes).
func (b *BlockChain) connectBestChain(node *blockNode, block *grhutil.Block, flags BehaviorFlags) (bool, error) {
...
type IndexManager interface {
	...
	// main chain.
	ConnectBlock(database.Tx, *grhutil.Block, *UtxoViewpoint) error

	// DisconnectBlock is invoked when a block has been disconnected from
	// the main chain.
	DisconnectBlock(database.Tx, *grhutil.Block, *UtxoViewpoint) error
}
