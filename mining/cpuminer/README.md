...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/grhsuite/grhd/mining/cpuminer)
...
```bash
$ go get -u github.com/grhsuite/grhd/mining/cpuminer
```
